...
Fraction operator-(const Fraction &fraction, int integer) {
  return Fraction(fraction.numerator - integer * fraction.denominator, fraction.denominator);
}

Fraction operator-(int integer, const Fraction &fraction) {
  return Fraction(integer * fraction.denominator - fraction.numerator, fraction.denominator);
}
